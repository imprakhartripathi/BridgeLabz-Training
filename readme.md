...
### **Week 3 Contd. — Core OOPS Foundations**

📅 *Started: 29-Dec-2025 (Monday)*

**Focus:**  
OOPs basics, structured problem-solving, and progressive difficulty handling.

---

### 📅 **30 Dec — Branch Creation & Problems on Class & Objects**

**Level 1 Questions on Classes & Objects**
Includes: 
- `Book.java`
- `Circle.java`
- `Employee.java`
...
**Level 2 Questions on Classes & Objects**
Includes: 
- `BankAccount.java`
- `CartItem.java`
- `MovieTicket.java`
